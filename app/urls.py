...
urlpatterns = [
    ...
    path('product-detail/<int:pk>', views.ProductDetaileView.as_view(), name='product-detail'),
    ...
    # Registration 
    path('registration/', views.CustomerResistrationView.as_view(), name = "customerregistration"),
